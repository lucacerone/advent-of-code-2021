from utils import deterministic_die, update_player_state_from_rolls, PlayerState
...
while True:
    ...
    p1 = update_player_state_from_rolls(p1, rolled)
    ...
    rolled = next(die)
    n_rolls += rolls_per_turn
    p2 = update_player_state_from_rolls(p2, rolled)
    if p2.score >= 1000:
        break
