...
class Position():
    def __init__(self, aim=0, horizontal=0, depth=0):
        self._aim = aim
    ...
    def coordinates(self):
        return {"aim": self._aim, "horizontal": self._horizontal, "depth": self._depth}
    
    def __repr__(self):
        return f"{self.__class__.__name__}(aim={self._aim}, horizontal={self._horizontal}, depth={self._depth})"
